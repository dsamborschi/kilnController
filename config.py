...
### Cost Estimate
kwh_rate        = 0.07  # Rate in currency_type to calculate cost to run job
...
sim_t_env      = 75.0   # deg F (25 C)
sim_c_heat     = 100.0  # J/K  heat capacity of heat element
sim_c_oven     = 2000.0 # J/K  heat capacity of oven
sim_p_heat     = 1680.0 # W    heating power of oven
...
temp_scale          = "f" # c = Celsius | f = Fahrenheit - Temperature inits used by thermocouple
