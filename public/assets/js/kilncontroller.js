      ...
      for (var i=0; i<profiles[id].data.length; i++)
       {
        ...
        new_data.push([new_data[j][0] + (profiles[id].data[i][1]/(profiles[id].data[i][0]/60)*60,profiles[id].data[i][1]]);
        //new_data[j+1][1] = profiles[id].data[i][1];
        //new_data[j+2][0] = new_data[j+1][0] + profiles[id].data[i][2];
        //new_data[j+2][1] = profiles[id].data[i][1];
        new_data.push([(new_data[j+1][0] + profiles[id].data[i][2]*3600),profiles[id].data[i][1]]);
        j = j + 1
       }
