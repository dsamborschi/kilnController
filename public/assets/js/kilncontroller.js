...
function updateProfileTable()
{
	...
	html += '<td><div class="input-group"><span class="glyphicon glyphicon-circle-arrow-' + slope + ' input-group-addon ds-trend" style="background: '+color+'"></span><input type="text" class="form-control-rate ds-input"  value="0" id="rate-'+i+'"  style="width: 100px" /></div></td>';
        html += '<td>&nbsp;</td></tr>';
    }
